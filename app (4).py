...
with demo:
    gr.Markdown("🧘‍♀️ **Diseases and its symptoms**")
    gr.Markdown(
    ...
    chatbot = gr.ChatInterface(
        respond,
        examples=[
            ["write symptoms of hepatitis"],
            ["Iam having a large circular rash around or near the site of tick bite, which disease iam suffering from?"],
            ["Is measles contagious?"],
            ["which is the disease in which The bacterium is passed from person to personwhen they are in very close contact. It is spread throughinfectious droplets of respiratory tract secretions ?"],
        ],
        title='Diseases and its symptoms 👩‍⚕️'
    )
